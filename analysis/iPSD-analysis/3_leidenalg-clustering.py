...
'''
title: 
description: Leidenalg Clustering 
...
## FIXME: there is a leidenalg setting that should be used instead!
max_size = 100 # Maximum allowable size of a module

###############################################################################
# Optimization methods:
optimization_method = recursive_method = 'CPM'
###############################################################################

# Prefix out output partition, saved as .csv.
output_name = optimization_method.lower()  + ""
...
methods = {
        ...
        "CPM": {'partition_type' : 'CPMVertexPartition',
            ...
            'n_iterations' : n_iterations,
            'multi_resolution' : True },
        # Significance - for sparse graphs
        "Significance":
